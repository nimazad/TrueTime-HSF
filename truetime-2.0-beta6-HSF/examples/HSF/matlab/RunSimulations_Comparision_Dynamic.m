...
for cnt=1:numberOfSimulation
    numberOfSimulation
    maxSystemUtilization = .5;
    while maxSystemUtilization < 1.3
        maxSystemUtilization = maxSystemUtilization + .1
        maxExecTime = maxSystemUtilization - SystemUtilization;
        cnt
        for t=1:2
            MissRatio = 0;
    ...
    save('ControlFrequencyData_Comparision_Dynamic6.mat', 'output');
end  
    return
    %%
    subplot(2,1,1)
