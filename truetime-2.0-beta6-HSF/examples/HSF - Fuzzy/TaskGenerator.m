function [TaskPeriods, TaskExecTimes, TaskNames, ServerPeriods, ServerBudgets, ServerNames] = TaskGenerator(numberOfServers, NumberOfTaskInServer, minPeriod, maxPeriod, SystemUtilization, Adaptive, Dynamic, maxExecTime)
...
if ~Adaptive
    if Dynamic
        %S1T3
        %TaskExecTimes(1,3) = TaskExecTimes(1,3) + TaskPeriods(1,3)* maxExecTime;
