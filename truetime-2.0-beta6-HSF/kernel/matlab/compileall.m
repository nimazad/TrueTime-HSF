...
disp('');
mex ttAttachNetworkHandler.cpp
disp('ttAttachNetworkHandler.cpp');
disp('');
mex ttAttachTriggerHandler.cpp
...
disp('');
mex ttGetRemainedCPUTime.cpp  
disp('ttGetRemainedCPU.cpp');
disp('');
mex ttGetUnusedBudget.cpp  
disp('ttGetUnusedBudget.cpp');
disp('');
mex ttGetWCET.cpp
disp('ttGetWCET.cpp');
disp('');
...
disp('');
mex ttResetCBSError.cpp
disp('ttResetCBSError.cpp');
disp('');
mex ttRetrieve.cpp
disp('ttRetrieve.cpp');
disp('');
...
disp('');
mex ttSetCBSParameters.cpp
disp('ttSetCBSParameters.cpp');
disp('');
mex ttSetCPUAffinity.cpp
